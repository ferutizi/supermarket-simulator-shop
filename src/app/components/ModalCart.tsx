...
export default function ModalCart() {
  ...
  return (
    <>
      {
        showModalCart &&
        <section className="z-10 w-[48%] h-[30rem] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          <header className="flex justify-between px-4 py-2 bg-sky-600">
            <h2>CARRITO</h2>
            <button className="w-6 h-6 bg-red-600 font-bold rounded-sm" onClick={() => closeModal()}>X</button>
          </header>
